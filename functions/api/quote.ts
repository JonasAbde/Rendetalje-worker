...
function getClientIp(headers: HeaderReader): string {
  // Use CF-Connecting-IP exclusively to prevent IP spoofing attacks.
  // X-Forwarded-For can be easily spoofed by clients and should not be trusted for rate limiting.
