...
## 2026-05-25 - Mobile Menu Accessibility
...
**Action:** When creating or modifying interactive mobile menus, always ensure they have complete ARIA relationships (`aria-expanded`, `aria-controls`, `id`) and can be closed via keyboard navigation (Escape key).
