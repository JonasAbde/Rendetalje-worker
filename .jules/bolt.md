...
## 2024-05-24 - Avoid lazy loading for initial routes
...
**Action:** Eagerly import critical initial routes instead to ensure the application loads as fast as possible.
