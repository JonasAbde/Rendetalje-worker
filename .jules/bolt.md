...
## 2024-05-24 - Eagerly load root routes
**Learning:** Using `React.lazy()` for the initial/root route component introduces an unnecessary network roundtrip that delays the First Contentful Paint (FCP).
**Action:** Always use static imports for critical initial routes and only apply code splitting to less important pages.
