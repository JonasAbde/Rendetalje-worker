...
## 2024-05-25 - Eager load initial route for faster FCP
...
**Action:** Eagerly import critical initial routes and reserve `React.lazy()` for secondary routes to optimize initial load times.
