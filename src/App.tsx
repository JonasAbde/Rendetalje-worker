...
// Eager load the initial route component to prevent an unnecessary network roundtrip
// that delays the First Contentful Paint (FCP). Secondary routes remain lazy-loaded.
