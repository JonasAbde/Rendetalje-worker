...
export default function Hovedrengoering() {
  const service = coreServices.find((s) => s.id === "hovedrengoering");
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://rendetalje.dk/services/hovedrengoering" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://rendetalje.dk/images/service-hoved.webp" />
        <meta property="og:locale" content="da_DK" />
      </Helmet>
      <ServicePageTemplate
        title={service.title}
        intro={service.desc}
        image="/images/service-hoved.webp"
