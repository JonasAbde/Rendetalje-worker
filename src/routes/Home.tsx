        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Ægte anmeldelser fra vores kunder i Aarhus og omegn.
            </p>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              {
                quote:
                  "Det blev rigtig fint sidste gang, selvom de kom på hårdt arbejde. Jeg har gigt og kan ikke gøre det grundigt selv. Så det er fantastisk at I kan hjælpe.",
                name: "Pernille Molin",
                location: "Silkeborg",
              },
              {
                quote:
                  "Tak for sidst! Det ser så fint ud. Jeg er meget tilfreds.",
                name: "Julie",
                location: "Aarhus",
              },
              {
                quote:
                  "Super service. Kom til tiden og gjorde et grundigt stykke arbejde.",
                name: "Michael",
                location: "Aarhus",
              },
            ].map((t, i) => (
              ...
              >
                <div className="mb-5">
                  <svg
                    ...
                    aria-hidden="true"
                  >
                    <path d="M4.583 17.321C3.553 16.227 3 15 3 13.011c0-3.5 2.457-6.637 6.03-8.188l.893 1.378c-3.335 1.804-3.987 4.145-4.247 5.621.537-.278 1.24-.375 1.929-.311C9.591 11.69 11 13.159 11 15c0 1.93-1.57 3.5-3.5 3.5-1.296 0-2.49-.701-3.083-1.729l.166-.45zM14.583 17.321C13.553 16.227 13 15 13 13.011c0-3.5 2.457-6.637 6.03-8.188l.893 1.378c-3.335 1.804-3.987 4.145-4.247 5.621.537-.278 1.24-.375 1.929-.311C19.591 11.69 21 13.159 21 15c0 1.93-1.57 3.5-3.5 3.5-1.296 0-2.49-.701-3.083-1.729l.166-.45z" />
                  </svg>
                </div>
                <blockquote className="text-slate-700 italic leading-relaxed mb-6 flex-1">
                  "{t.quote}"
                </blockquote>
