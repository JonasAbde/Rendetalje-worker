...
// ⚡ Bolt: Hoist massive static JSON-LD schemas to module scope
// This prevents recreating these large objects on every render (which happens on every route change),
