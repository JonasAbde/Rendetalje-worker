...
// ⚡ Bolt: Hoisting massive static schema objects (localBusinessSchema, websiteSchema, organizationSchema)
// to the module scope to meaningfully reduce garbage collection pressure on every render.
