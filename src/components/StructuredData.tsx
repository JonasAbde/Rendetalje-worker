...
// Optimization: Move massive static JSON-LD schema objects outside the component
// to prevent expensive re-allocation and garbage collection pressure on every render.
